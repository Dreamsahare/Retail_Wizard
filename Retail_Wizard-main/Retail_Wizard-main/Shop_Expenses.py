...
class ShopExpensesApp:
    def __init__(self, root):
        ...
        btn_calculate_expenses = Button(self.root, text="Calculate Expenses", font=("Arial", 14, "bold"), bg="green", fg="white", command=self.calculate_expenses)
        btn_calculate_expenses.place(x=50, y=320, width=200)

        btn_calculate_profit = Button(self.root, text="Calculate Profit", font=("Arial", 14, "bold"), bg="blue", fg="white", command=self.calculate_profit)
        btn_calculate_profit.place(x=350, y=320, width=200)

        btn_total_revenue = Button(self.root, text="Total Revenue", font=("Arial", 14, "bold"), bg="orange", fg="white", command=self.calculate_total_revenue)
